  ...
  const userColumns = [
    ...
    { title: "Email", dataIndex: "email", key: "email" },
    {
      ...
      render: (contact: string | undefined) =>
        contact && contact.toLowerCase() !== "unknown" ? contact : "N/A", // Unknown Ï≤òÎ¶¨
    },
    {
      title: "Status",
      dataIndex: "status",
  ...
  const studentColumns = [
    ...
    },
    {
      ...
      render: (birth: string | undefined) =>
        birth && birth.toLowerCase() !== "unknown" ? birth : "N/A", // Unknown Ï≤òÎ¶¨
    },
    {
      title: "Age",
      dataIndex: "age",
        ...
        <div className="bg-white p-4 rounded-lg shadow-lg">
          <div className="flex justify-between mb-4">
            ...
            <Button
              type="primary"
              onClick={() => {
                setSelectedUser(null); // Í∏∞Ï°¥  Ñ† Éù êú User  ï¥ †ú
                setSelectedStudent(null); // Í∏∞Ï°¥  Ñ† Éù êú Student  ï¥ †ú
                form.resetFields(); //  èº Ï¥àÍ∏∞ ôî
                setIsDrawerOpen(true); // Drawer  ó¥Í∏ 
              }}
            >
              Add Student
            </Button>
          ...
          <Pagination
            ...
            onChange={handlePaginationChange}
            className="flex justify-center mt-4" // Ï§ëÏïô  †ï †¨
          />
        </div>
      ),
    },
    ...
    <div className="flex h-screen font-sans bg-gray-100 overflow-auto">
      ...
      >
        <Form form={form} layout="vertical">
          ...
          {currentTab === "1" && ( // Users  É≠ óê ÑúÎß  Status  ëú ãú
            <Form.Item
              label="Status"
              name="status"
              valuePropName="checked"
              initialValue={true} // Í∏∞Î≥∏Í∞   Ñ§ †ï
            >
              <Switch />
            </Form.Item>
          )}
